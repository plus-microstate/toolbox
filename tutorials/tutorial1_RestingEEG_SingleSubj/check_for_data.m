...
datadir = fullfile(fileparts(toolbox_path),'example','example1_RestingEEG_SingleSubj') ; % path to folder containing the data
addpath(datadir) % add this to the path

% Check if the data is in the data directory
if ~exist(fullfile(datadir,'example1_data.mat'),'file')
    ...
    switch answer
        case 'Yes'
            ...
            % Install the data
            datafile = fullfile(datadir,'example1_data.mat') ;
