function [objopt,kopt,kvec,maps,gev] = cluster_globalkoptimum(obj,varargin)
% Calculate optimum microstate maps at the group level. 
    ...
    newopt = options ; newopt.findpeaks = false ; 
     ...
     % cluster
    [newcoh,kopt,kvec,maps,gev] = newcoh.cluster_koptimum(newopt) ; 
    
    %% Update cohort object
    objopt = obj ; 
    objopt.globalmaps = newcoh.maps ; 
    
    obj = microstate.functions.process_append(obj,'Calculated global optimum number of maps',options) ;
