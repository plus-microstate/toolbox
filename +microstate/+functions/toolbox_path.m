...
%     fullfile('+microstate','+external','fieldtrip','template','layout','neuromag306.mat'), false ; ...
    fullfile('examples','example1_EEGcanonicalmaps','example1_data.mat'), true , [] , 20371066 ; ...
    fullfile('examples','example2_MEGtopographicERP','example2_data.mat'), true, [], 186929384 ; ...
    fullfile('examples','example4_GroupAnalysisSourceMEG','example4_data.mat'), true , [] , 44339606 ; ...
    fullfile('examples','example4_GroupAnalysisSourceMEG','layout.mat'), true, [], 42515} ;
